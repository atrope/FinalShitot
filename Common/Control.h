...
public:
	Control() : left(1), top(1),cursorLoc(2), isFocus(true), width(0), height(0), isBorder(false),parentTop(0),parentLeft(0), connected_control(NULL),background(Color::Black),foreground(Color::White){};
